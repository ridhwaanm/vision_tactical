...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!----> `);
    JsonLd($$renderer2);
    $$renderer2.push(`<!----> <div class="bg-[#09090B]"><section class="relative min-h-screen flex items-center justify-center overflow-hidden"><div class="absolute inset-0 z-0"><div class="absolute inset-0 bg-gradient-to-b from-[#09090B]/80 via-[#09090B]/60 to-[#09090B] z-10"></div> <div class="absolute inset-0 bg-[url('/images/hero/main.jpg')] bg-cover bg-center"></div></div> <div class="glow-ambient glow-ambient-top"></div> `);
    Spotlight($$renderer2, {
      children: ($$renderer3) => {
        $$renderer3.push(`<div class="container mx-auto px-4 py-32 relative z-20 text-center"><p class="overline mb-6">PROTECTING COMMUNITIES · PREVENTING CRIME</p> <h1 class="heading-gradient mb-6 max-w-4xl mx-auto">Security That Never Sleeps</h1> <p class="text-zinc-400 text-lg md:text-xl max-w-2xl mx-auto mb-10">Johannesburg's most trusted private security company. Armed response, manned guarding, 
          drone surveillance, and anti-kidnapping operations.</p> <div class="flex flex-col sm:flex-row items-center justify-center gap-4"><a href="/get-a-quote" class="btn btn-primary px-8 py-4 text-base">Get Protected Today</a> <a href="/services" class="btn btn-secondary px-8 py-4 text-base">Our Services</a></div> <div class="mt-20 pt-10 border-t border-zinc-800"><p class="text-zinc-500 text-sm mb-6">TRUSTED BY 34,700+ COMMUNITY MEMBERS</p> <div class="flex flex-wrap items-center justify-center gap-8 text-zinc-400 text-sm"><span class="flex items-center gap-2"><svg class="w-5 h-5 text-red-500" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg> 2025 Excellence Award</span> <span class="flex items-center gap-2"><svg class="w-5 h-5 text-red-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"></path></svg> 168+ Arrests</span> <span class="flex items-center gap-2"><svg class="w-5 h-5 text-red-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M3 3a1 1 0 000 2v8a2 2 0 002 2h2.586l-1.293 1.293a1 1 0 101.414 1.414L10 15.414l2.293 2.293a1 1 0 001.414-1.414L12.414 15H15a2 2 0 002-2V5a1 1 0 100-2H3zm11.707 4.707a1 1 0 00-1.414-1.414L10 9.586 8.707 8.293a1 1 0 00-1.414 0l-2 2a1 1 0 101.414 1.414L8 10.414l1.293 1.293a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg> ER24 Partner</span> <span class="flex items-center gap-2"><svg class="w-5 h-5 text-red-500" fill="currentColor" viewBox="0 0 20 20"><path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"></path></svg> Drone Pioneers</span></div></div></div>`);
      }
    });
    ...
    $$renderer2.push(`<!--]--></div> <div class="text-center mt-12"><a href="/services" class="btn btn-secondary">View All Services</a></div></div></section> <section class="section relative bg-[#0F0F12] border-y border-zinc-800"><div class="glow-ambient glow-ambient-bottom"></div> <div class="container mx-auto px-4 relative z-10"><div class="grid grid-cols-2 md:grid-cols-4 gap-8"><div class="text-center"><p class="text-4xl md:text-5xl font-bold text-white mb-2"><span>${escape_html(stats.arrests)}</span>+</p> <p class="text-zinc-500 text-sm uppercase tracking-wider">Arrests</p></div> <div class="text-center"><p class="text-4xl md:text-5xl font-bold text-white mb-2"><span>${escape_html(stats.kidnappingCases)}</span></p> <p class="text-zinc-500 text-sm uppercase tracking-wider">Kidnapping Cases</p></div> <div class="text-center"><p class="text-4xl md:text-5xl font-bold text-white mb-2"><span>${escape_html(stats.vehiclesSeized)}</span>+</p> <p class="text-zinc-500 text-sm uppercase tracking-wider">Vehicles Seized</p></div> <div class="text-center"><p class="text-4xl md:text-5xl font-bold text-white mb-2">R700M+</p> <p class="text-zinc-500 text-sm uppercase tracking-wider">Ransoms Prevented</p></div></div></div></section> <section class="section relative"><div class="container mx-auto px-4"><div class="text-center mb-16"><p class="overline mb-4">TESTIMONIALS</p> <h2 class="heading-gradient text-3xl md:text-4xl font-bold mb-4">What Our Clients Say</h2></div> <div class="grid grid-cols-1 md:grid-cols-3 gap-6"><!--[-->`);
