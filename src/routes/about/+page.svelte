...
<svelte:head>
  <title>About Us | Vision Tactical | Johannesburg Security Company</title>
  <meta
    name="description"
    content="Learn about Vision Tactical's mission, values, and commitment to community safety in Johannesburg. Founded on principles of excellence and innovation."
  />
</svelte:head>
...
<div class="bg-base">
  ...
  <section class="relative py-24 md:py-32 overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
      <div class="max-w-4xl" use:reveal>
        <p class="overline mb-4">ABOUT US</p>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="relative" use:reveal>
          <div class="aspect-[4/3] rounded-2xl overflow-hidden bg-gradient-to-br from-elevated to-base">
            <div class="absolute inset-0 bg-[url('/images/team/operations.jpg')] bg-cover bg-center opacity-60"></div>
            <div class="absolute inset-0 bg-gradient-to-t from-base via-transparent to-transparent"></div>
          </div>
          <!-- Stats overlay -->
          <div class="absolute -bottom-6 -right-6 card p-6 bg-gradient-to-br from-red-900/20 to-surface">
            <p class="text-3xl font-bold text-primary mb-1">34,700+</p>
            <p class="text-secondary text-sm">Community Members Protected</p>
          </div>
        </div>
  ...
  <section class="py-24 bg-surface border-y border-line">
    <div class="container mx-auto px-4">
      <div class="text-center mb-16" use:reveal>
        <p class="overline mb-4">OUR VALUES</p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <GlowCard>
          <div class="p-6">
            ...
            <h3 class="text-primary font-semibold mb-2">Innovation</h3>
            <p class="text-secondary text-sm">Pioneering new technologies and methods to stay ahead of threats.</p>
          </div>
        </GlowCard>
        ...
        <GlowCard>
          <div class="p-6">
            ...
            <h3 class="text-primary font-semibold mb-2">Community</h3>
            <p class="text-secondary text-sm">Deep commitment to the neighborhoods we serve and protect.</p>
          </div>
        </GlowCard>
        ...
        <GlowCard>
          <div class="p-6">
            ...
            <h3 class="text-primary font-semibold mb-2">Excellence</h3>
            <p class="text-secondary text-sm">Uncompromising standards in training, equipment, and service delivery.</p>
          </div>
        </GlowCard>
        ...
        <GlowCard>
          <div class="p-6">
            ...
            <h3 class="text-primary font-semibold mb-2">Trust</h3>
            <p class="text-secondary text-sm">Building lasting relationships through reliability and integrity.</p>
          </div>
        </GlowCard>
      </div>
    </div>
  ...
  <section class="py-24">
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <!-- Left: Content -->
        <div class="order-2 lg:order-1" use:reveal>
          <p class="overline mb-4">LEADERSHIP</p>
          <h2 class="text-2xl font-bold text-primary mb-6">Yaseen Theba — Director</h2>
        ...
        <!-- Right: Image -->
        <div class="order-1 lg:order-2" use:reveal={{ delay: 100 }}>
          <div class="aspect-[3/4] max-w-md mx-auto rounded-2xl overflow-hidden bg-gradient-to-br from-elevated to-base">
            <div class="absolute inset-0 bg-[url('/images/team/yaseen-theba.jpg')] bg-cover bg-center"></div>
            <div class="absolute inset-0 bg-gradient-to-t from-base via-transparent to-transparent"></div>
          </div>
        </div>
      </div>
  ...
  <section id="partnerships" class="py-24 bg-surface border-y border-line">
    <div class="container mx-auto px-4">
      <div class="text-center mb-16" use:reveal>
      ...
      {#each categories as category, ci}
        ...
        <div class="mb-16 last:mb-0" use:reveal={{ delay: ci * 100 }}>
          <div class="flex items-center gap-3 mb-2">
            ...
            {/if}
            <h3 class="text-primary font-semibold text-lg">{categoryInfo.label}</h3>
          </div>
          <p class="text-muted text-sm mb-6 ml-8">{categoryInfo.intro}</p>
            ...
            {#each categoryPartners as partner}
              <GlowCard>
                <div class="p-6">
                  ...
                  {/if}
                  <div class="mb-3">
                    <h4 class="text-primary font-semibold">{partner.name}</h4>
                    <p class="text-muted text-xs uppercase tracking-wider">{partner.tagline}</p>
                  </div>
                  <p class="text-secondary text-sm leading-relaxed">{partner.description}</p>
                  <div class="flex flex-wrap gap-3 mt-3">
                    {#if partner.website}
                      <a
                        ...
                        class="inline-flex items-center gap-1 text-muted hover:text-accent-red text-xs transition-colors"
                      >
                        Visit website
    ...
    <div class="container mx-auto px-4 relative z-10">
      <div class="card p-8 md:p-12 text-center max-w-3xl mx-auto" use:reveal>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a href="/careers" class="btn btn-secondary px-8 py-4">
            View Careers
          </a>
        </div>
      </div>
...
{#if certModalOpen}
  ...
  >
    <div class="relative max-w-lg w-full" on:click|stopPropagation>
      <button
        on:click={closeCert}
        class="absolute -top-3 -right-3 z-10 w-8 h-8 rounded-full bg-elevated border border-line-strong flex items-center justify-center text-secondary hover:text-primary transition-colors"
        aria-label="Close"
      >
      ...
      <img
        ...
        class="w-full rounded-lg border border-line-strong shadow-2xl"
      />
    </div>
  </div>
{/if}
