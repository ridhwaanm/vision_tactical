...
<svelte:head>
  <title>Careers | Vision Tactical | Security Jobs Johannesburg</title>
  <meta
    name="description"
    content="Join the Vision Tactical team. Explore career opportunities in private security with competitive salaries, training, and advancement."
  />
</svelte:head>
...
<div class="bg-[#09090B]">
  ...
  <section class="relative py-24 md:py-32 overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
      <div class="max-w-4xl" use:reveal>
        <p class="overline mb-4">CAREERS</p>
        ...
        <div use:reveal>
          ...
          <div class="space-y-4 text-zinc-400 leading-relaxed">
            <p>
              ...
              to protect communities and prevent crime.
            </p>
            <p>
              We invest heavily in training and development, ensuring our team has the 
            ...
            <p>
              ...
              and hard work are recognised and rewarded.
            </p>
          </div>
        </div>
  ...
  <section class="py-24">
    <div class="container mx-auto px-4">
      <div class="text-center mb-16" use:reveal>
        <p class="overline mb-4">POSITIONS</p>
        <h2 class="heading-gradient text-3xl md:text-4xl font-bold mb-4">
          Current Openings
        </h2>
    ...
    <div class="container mx-auto px-4">
      <div class="max-w-2xl mx-auto">
        <div class="text-center mb-12" use:reveal>
          <p class="overline mb-4">GENERAL APPLICATION</p>
          <h2 class="heading-gradient text-3xl md:text-4xl font-bold mb-4">
            Don't See Your Role?
          </h2>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="armed-response">Armed Response Officer</option>
