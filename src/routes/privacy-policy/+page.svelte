...
<svelte:head>
  <title>Privacy Policy | Vision Tactical | POPIA Compliant</title>
  <meta
    name="description"
    content="Vision Tactical privacy policy outlining how we collect, use, and protect your personal information in accordance with POPIA."
  />
</svelte:head>
      ...
      <div class="max-w-3xl mx-auto">
        <div class="card p-8 md:p-12" use:reveal>
          <div class="prose prose-invert max-w-none">
            ...
            <p>
              Vision Tactical ("we", "our", "us") is committed to protecting your privacy. 
            ...
            <ul>
              <li><strong>Identity Information:</strong> Name, ID number, passport number</li>
              <li><strong>Contact Information:</strong> Address, phone number, email address</li>
              <li><strong>Property Information:</strong> Property address, size, access points</li>
              <li><strong>Security Information:</strong> Alarm codes, access codes, security requirements</li>
              <li><strong>Financial Information:</strong> Bank account details, payment history</li>
            ...
            <ul>
              ...
              <li>Responding to emergencies and security incidents</li>
            ...
            <ul>
              ...
              <li>Law enforcement agencies (SAPS) when required by law</li>
              <li>Emergency services (ER24, fire department) when necessary</li>
              <li>Our professional advisors (lawyers, accountants, auditors)</li>
            ...
            <p>
              ...
              This includes encryption, access controls, and secure storage facilities.
            </p>
            ...
            <p>
              ...
              is typically retained for 30-90 days unless required for investigation purposes.
            </p>
