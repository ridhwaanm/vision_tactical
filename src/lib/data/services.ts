...
export const services: Service[] = [
  {
    ...
    shortDescription:
      'Professional security officers for residential, commercial, and corporate properties with on-site surveys and H&S assessments.',
    icon: 'shield',
...
Every security contract we undertake is personally overseen by one of our Directors, ensuring the highest level of accountability and service delivery.`,
    ...
    seo: {
      ...
      description:
        'Professional manned guarding services in Johannesburg. PSIRA-registered security officers for residential, commercial, and corporate properties.'
    }
  },
  {
    slug: 'armed-response',
    ...
    shortDescription:
      'Rapid reaction officers, CCTV monitoring, alarm response, and patrol services for immediate threat intervention.',
    icon: 'siren',
...
All response officers are extensively trained in tactical response, firearms handling, and emergency medical care, ensuring they can handle any situation professionally.`,
    ...
    seo: {
      ...
      description:
        '24/7 armed response security in Johannesburg. Rapid reaction officers, alarm monitoring, and CCTV surveillance for immediate threat response.'
    }
  },
  {
    slug: 'vip-protection',
    ...
    shortDescription:
      'Executive protection services with advance planning, route risk assessment, and close protection officers.',
    icon: 'user-shield',
...
We specialise in both residential protection and mobile escort services, ensuring our clients remain safe whether at home, in transit, or attending events.`,
    ...
    seo: {
      ...
      description:
        'Professional close protection and VIP security services in Johannesburg. Executive protection, bodyguards, and advance security planning.'
    }
  },
  {
    ...
    shortDescription:
      'ER24 partnership providing 280+ emergency vehicles, 24/7 contact centre, and on-scene medical response.',
    icon: 'heart-pulse',
...
We also offer stand-by medical services for events, ensuring professional medical coverage for your corporate functions, sporting events, or private gatherings.`,
    ...
    seo: {
      ...
      description:
        '24/7 emergency medical response through our ER24 partnership. Ambulance services, event medical cover, and BLS-trained security officers.'
    }
  },
  {
    ...
    shortDescription:
      'Pioneering aerial crime combat operations with thermal imaging, aerial reconnaissance, and real-time monitoring.',
    icon: 'drone',
...
Our drone pilots are fully licensed by the South African Civil Aviation Authority (SACAA) and operate under strict regulations. We maintain comprehensive insurance and follow all airspace protocols.`,
    ...
    seo: {
      ...
      description:
        'Advanced drone surveillance and aerial security operations in Johannesburg. Thermal imaging, real-time monitoring, and SACAA-licensed pilots.'
    }
  },
  {
    ...
    shortDescription:
      'Pro-bono SAPS partnership with specialised Kidnapping Analysis Unit (KAU) for victim rescue and intelligence-driven operations.',
    icon: 'handcuffs',
...
Our team includes former law enforcement professionals with extensive experience in hostage rescue, criminal investigation, and intelligence analysis.`,
    ...
    seo: {
      ...
      description:
        'Pro-bono anti-kidnapping services in partnership with SAPS. Kidnapping rescue, intelligence operations, and victim recovery at no cost to families.'
    }
  },
  {
    slug: 'cctv-alarms',
    ...
    shortDescription:
      'Complete security camera systems, alarm installation, 24/7 monitoring, and remote access control solutions.',
    icon: 'video',
...
We offer comprehensive maintenance contracts to keep your systems in optimal working condition, with regular inspections and prompt repairs when needed.`,
    ...
    seo: {
      ...
      description:
        'Professional CCTV camera and alarm system installation in Johannesburg. 24/7 monitoring, remote access, and integrated armed response.'
    }
  },
  {
    slug: 'event-security',
    ...
    shortDescription:
      'Comprehensive security for large-scale events including crowd management, access control, and emergency medical cover.',
    icon: 'users',
...
All our event security staff are professionally trained in crowd psychology, conflict resolution, and emergency procedures.`,
    ...
    seo: {
      ...
      description:
        'Professional event security for corporate functions, festivals, and sporting events. Crowd management, access control, and medical cover.'
    }
  },
  {
    slug: 'dog-handling',
    ...
    shortDescription:
      'Professional K9 units including patrol dogs, detection dogs, and handler teams for enhanced security operations.',
    icon: 'dog',
...
K9 units can be deployed as standalone services or integrated with manned guarding and armed response operations for enhanced effectiveness.`,
    ...
    seo: {
      ...
      description:
        'Professional K9 security services in Johannesburg. Patrol dogs, detection dogs, and certified handler teams for enhanced security.'
    }
  }
];
