<script lang="ts">
  ...
  const socialLinks = [
    ...
    { name: 'X (Twitter)', href: '#', icon: 'M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z' },
      ...
      <div>
        ...
        <ul class="space-y-4">
          <li class="flex items-start space-x-3">
            ...
            <span class="text-zinc-400 text-sm">49 W Street, Houghton, Johannesburg</span>
          </li>
