...
<footer class="bg-[#09090B] border-t border-zinc-800">
  <div class="container mx-auto px-4 py-16">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
      ...
      <div>
        <img src="/images/logo-navbar.svg" alt="Vision Tactical" class="h-10 w-auto mb-6" />
      ...
      <div>
        ...
        <ul class="space-y-4">
          ...
          <li class="flex items-center space-x-3">
            ...
            <a href="tel:0842222222" class="text-zinc-400 hover:text-white text-sm transition-colors">084 222 2222</a>
          </li>
          <li class="flex items-center space-x-3">
            <svg class="w-5 h-5 text-red-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
